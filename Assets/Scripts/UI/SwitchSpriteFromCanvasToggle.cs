...
public class SwitchSpriteFromCanvasToggle : CanvasToggleListener
{
    public Sprite AllTogglesOffSprite;
    public Sprite OneToggleOnSprite;
    ...
    public override void RefreshFromCanvasToggleChange()
    {
        ...
        _mainImage.sprite = areAllOff ? AllTogglesOffSprite : OneToggleOnSprite;
    }
}
